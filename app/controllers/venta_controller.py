...
def registrar_venta(moto_id: int, cliente_id: int, vendedor_id: int, precio_final: float, metodo_pago: str) -> sqlite3.Row:
    ...
    venta_id = venta_model.registrar(moto_id, cliente_id, vendedor_id, precio_final, metodo_pago)
